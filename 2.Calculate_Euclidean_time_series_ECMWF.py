...
# -*- coding: utf-8 -*-
"""
Calculate a time series of BMU using a Euclidean distance measure for ERA20C and ECMWF data.

Created on Fri March 15 12:00:00 2019
...
def create_year_histogram(node_dataset,som_number,year_array):
    ...
    time_array= np.arange(1979,2015)  
...
for latitude_1 in [90,60,30,0,-30,-60]:
    for longitude_1 in [20,80,140,200,260,-40]:
        longitude_1 = longitude_1 +50
        if longitude_1 ==260+50 :
            xarray_u_1 = xarray_u_0.u10.sel(longitude = slice(260 +50  ,360),latitude=slice(latitude_1,latitude_1-30 ))
            xarray_u_2 = xarray_u_0.u10.sel(longitude = slice(0,260-300 +50),latitude=slice(latitude_1,latitude_1-30 ))
            xarray_u = xr.merge((xarray_u_1,xarray_u_2))
                    
            xarray_v_1 = xarray_v_0.v10.sel(longitude = slice(260 +50,360),latitude=slice(latitude_1,latitude_1-30 ))
            xarray_v_2 = xarray_v_0.v10.sel(longitude = slice(0,260-300+50 ),latitude=slice(latitude_1,latitude_1-30 ))
...
# this is loading the reference SOM patterns for analysis 
        directoryname='D:/Shun_Li/2.1 SOM_pattern_figure/6.State6/'  # SHun Li to change
